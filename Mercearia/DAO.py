...
class DaoVenda:
    ...
    def salvar(cls, venda: Venda):
        with open('venda.txt', 'a') as arq:
            arq.writelines(venda.ItensVendidos.nome + "|" + venda.ItensVendidos.preco + "|" + venda.ItensVendidos.categoria + "|" + venda.vendedor + "|" + venda.comprador + "|" + str(venda.QuantVendida) + "|" + venda.data)
            arq.writelines('\n')
...
class DaoPessoa:
    ...
    def salvar(cls, pessoas: Pessoa):
        with open('clientes.txt', 'a') as arq:
            arq.writelines(pessoas.nome + "|" + pessoas.telefone + "|" + pessoas.cpf + "|" + pessoas.email + "|" + pessoas.endereco + "|" + pessoas.nascimento)
            arq.writelines('\n')
